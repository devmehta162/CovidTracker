...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tvCases,tvRecovered,tvCritical,tvActive,tvTodayCases,tvTodayDeaths,tvTotalDeaths,tvAfffectedCountries;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAfffectedCountries=findViewById(R.id.tvAffectedCountries);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            tvAfffectedCountries.setText(jsonObject.getString("affectedCountries"));
